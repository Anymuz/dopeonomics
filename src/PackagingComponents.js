...
export const PriceMarginInputs = ({ 
    ...
    // Track if the user has manually edited the price
    ...
    // Only set the sale price to recommended price when effects change if the user hasn't manually edited
    useEffect(() => {
      if (recommendedPrice > 0 && !manualEdit) {
        setSalePrice(recommendedPrice);
        calculateMarginFromSalePrice();
      }
    }, [recommendedPrice, setSalePrice, calculateMarginFromSalePrice, manualEdit]);
          ...
          <div className="flex-1 min-w-[200px]">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                onClick={() => {
                  calculateSalePriceFromMargin();
                  // Mark as manual edit to prevent auto-update
                  setManualEdit(true);
                }}
              >
