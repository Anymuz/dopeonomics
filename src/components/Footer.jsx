  ...
  return (
    <footer className="bg-gray-100 border-t border-gray-200 py-6 mt-8">
      <div className="max-w-5xl mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-aligned gap-4">
          {/* Disclaimer */}
          ...
          {/* Creator Credit */}
          <div className="flex flex-col items-justified mb-8">
          <div className="text-sm text-gray-600 justify-center flex flex-row items-center gap-2">
            <span>Created with</span>
            <Heart className="w-4 h-4 text-red-500" fill="currentColor" />
            <span>by</span>
            <span className="font-medium text-gray-700">Fustahson</span>
           </div>
           <div className="text-sm flex flex-row justify-center text-gray-600 items-center gap-2 ">
            <span>Engineered with</span>
            <Handshake className="w-4 h-4 text-yellow-500" />
            <span>by</span>
            <span className="font-medium text-gray-700">Anymuz</span>
            </div>
            </div>
        </div>
        {/* Copyright */}
